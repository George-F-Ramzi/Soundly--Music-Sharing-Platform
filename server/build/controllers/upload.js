        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = req.user;
                    files = req.files;
                    cover_url = files.cover_file[0].path;
                    song_url = files.song_file[0].path;
                    cover_id = files.cover_file[0].filename;
                    song_id = files.song_file[0].filename;
                    schema = joi_1.default.object({
                        name: joi_1.default.string().required().label("Song Name"),
                    });
