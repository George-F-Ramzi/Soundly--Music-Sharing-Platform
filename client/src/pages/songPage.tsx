...
import { ProfilePageType, Song } from "../lib/types.def";
import { Suspense, useContext, useEffect, useState } from "react";
import Loading from "../ComponentHelper/loading";
import PlayerContext from "../ComponentHelper/playerContext";
import LikeBtn from "../ComponentHelper/likeBtn";
import DislikeBtn from "../ComponentHelper/dislikeBtn";
...
function SongPage() {
  ...
  let song: Song = location.state.song;
